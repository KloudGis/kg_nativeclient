...
// in simulator we redefine to format for iOS Developer console
...
{\
	NSString * exceptionName = [@"org.ios." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ios";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIiOSNativeItemNone = -1, 
	UIiOSNativeItemSpinner = -2,
	UIiOSNativeItemProgressBar = -3,
	
	UIiOSNativeItemSlider = -4,
	UIiOSNativeItemSwitch = -5,
	UIiOSNativeItemMultiButton = -6,
	UIiOSNativeItemSegmented = -7,
	
	UIiOSNativeItemTextView = -8,
	UIiOSNativeItemTextField = -9,
	UIiOSNativeItemSearchBar = -10,
	
	UIiOSNativeItemPicker = -11,
	UIiOSNativeItemDatePicker = -12,
	
	UIiOSNativeItemInfoLight = -13,
	UIiOSNativeItemInfoDark = -14,
	
	UIiOSNativeItemDisclosure = -15,
	
	UIiOSNativeItemContactAdd = -16
};
